...
const processedVideoBucketName = "ycleee-yt-processed-videos";
...
export function convertVideo(rawVideoName: string, processedVideoName: string) {
    return new Promise<void>((resolve, reject) => {
        ...
        console.log(`I'm saving to ${localProcessedVideoPath}/${processedVideoName} and it's sucessfully saved.`);
    })
}
...
function ensureDirectoryExistence(dirPath: string) {
    ...
    console.log(`I'm checking directory. ${dirPath} exists.`);
  }